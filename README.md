...
<ul>
  ...
  <li><a href="#договор">Договор о стажировке</a></li>
...
Статья 434 ГК РФ: Договор в письменной форме может быть заключен путем обмена документами по электронной почте.  Статья 160 ГК РФ: Использование факсимильного воспроизведения подписи с помощью средств механического или иного копирования допускается в случаях, установленных законом.    
