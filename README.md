...
https://github.com/ВАШ_ЛОГИН/Data-Science-For-Beginners-from-scratch-SENATOROV/commits/, замените ВАШ_ЛОГИН на ваш логин :) [найти можно тут]([url](https://github.com/settings/admin) [👉СМОТРЕТЬ СКРИНШОТ](https://github.com/user-attachments/assets/7986dace-42ae-4507-a3dc-79ab73402571)
), потом копируете ссылку на последний коммит
