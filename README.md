...
https://github.com/ВАШ_ЛОГИН/Data-Science-For-Beginners-from-scratch-SENATOROV/commits/, замените ВАШ_ЛОГИН на ваш логин :) потом копируете ссылку на последний коммит
