...
2. **Присоединитесь к команде**
   ...
   - подпишитесь на [коллег1](https://github.com/orgs/SENATOROVAI/teams/senatorov-team)
   - подпишитесь на [коллег2](https://github.com/orgs/SENATOROVAI/teams/senatorov-intro) 
---

1. **Создайте новую ветку**
   - Перейдите на [страницу веток](https://github.com/SENATOROVAI/intro/branches) и создайте новую ветку, назвав её вашим [логином GitHub](https://github.com/settings/admin) без СОБАЧКИ @. [👉СМОТРЕТЬ СКРИНШОТ](https://github.com/user-attachments/assets/99f05e36-f698-486a-8f95-50225043fb22) 
...
- `` git clone --branch название-ветки ссылка_на_репозиторий_.git ``
