...
```
### 21. **Обзор ML** (Доступ только по согласованию с руководителем организации)
  - Вы должны объяснять вашу мотивацию на предоставления краткого обзорного курса по ML, например, хочу понять, моё ли направление или нет.
